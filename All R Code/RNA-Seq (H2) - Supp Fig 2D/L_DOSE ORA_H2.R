...
#for Nt vs. NL3 FL
#names(enriched_list) <- c("BP", "MF", "CC", "KL", "HDO", "HPO", "DGN")

#for NL3 FL vs. NL3 dICD

#names(enriched_list) <- c("BP", "MF", "CC", "KM", "DGN")


#for NL3 FL vs. NL3 ICD
#names(enriched_list) <- c("BP", "MF", "CC", "KL", "DGN")
